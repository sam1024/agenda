      ...
      <div class="container">
        ...
        <h2 id="msj"></h2>
                <form action="TransaccionesContacto.php" method="post" id="form">
                  <input type="text" id="nombre" name="nombre" class="input_field" placeholder="Nombre" autofocus value="">
                  <input type="text" id="tel" name="tel" class="input_field" placeholder="Telefono" value="">
                  <input type="text" id="direccion" name="direccion" class="input_field" placeholder="Direccion" value="">
                  <input type="email" id="email" name="email" class="input_field" placeholder="Correo" value="">
